...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "hello@abeleyasu.dev",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
          ...
          <div>
            <div>
              <p className="text-[35px] max-lg:hidden font-semibold text-nowrap text-[#132238]">
                Let’s discuss your Odoo project
              </p>
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm available for Odoo delivery, rescue projects, and ongoing
                support. Share your goals and timelines.
              </p>
            </div>
